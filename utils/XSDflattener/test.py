...
class TestSimpleXSD(unittest.TestCase):
	...
	def test_one_file(self):
		...
		# 1 simple type
		self.assertEqual(len(xmlTree.getroot().getchildren()), 1)
...
# 		self.assertEquals(len(xmlTree.getroot().getchildren()), 3)
	...
	def test_includes_local(self):
		...
		self.assertEqual(len(xmlTree.getroot().getchildren()), 3)
	...
	def test_multiple_includes_local(self):
		...
		self.assertEqual(len(xmlTree.getroot().getchildren()), 4)
